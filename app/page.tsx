...
import { ArrowRight, Github, Linkedin, Mail, FileText, ExternalLink } from "lucide-react"
          ...
          <div className="flex flex-col items-start gap-4 md:flex-row md:justify-between md:gap-8">
            <div className="space-y-6 md:max-w-[60%]">
              <div className="space-y-2">
                <p className="text-lg text-muted-foreground">Hello, My name is,</p>
                <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">Benard</h1>
                <p className="text-xl font-semibold text-primary">Frontend Engineer <span className="font-extrabold">|</span> OpenSource Contributor </p>
              </div>
              <p className="max-w-[600px] text-muted-foreground md:text-xl">
                I create websites that are a pleasure to use. I design them with beautiful typography, meaningful
                transitions, and thoughtful interactions that delight people.
              </p>
            ...
            <div className="w-full md:w-auto">
              <div className="flex flex-col gap-2 min-w-[240px] rounded-xl border bg-card p-6 shadow-sm">
        ...
        <section className="space-y-6 py-8 md:py-12">
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              ...
              <p className="text-muted-foreground">Some of my recent work and open-source contributions.</p>
            </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <ProjectCard
              title="that'swhatshesaid"
              description="Discord bot serving random quotes from the tv-show (The Office)"
              tags={["TypeScript", "Discord.js", "Node.js"]}
              githubUrl="https://github.com/username/thats-what-she-said-bot"
              demoUrl="https://discord.com/api/oauth2/authorize?client_id=123456789&permissions=0&scope=bot"
            />
            <ProjectCard
              title="find-tunes"
              description="An album finder that lets you find albums from your favorite artists using Spotify's API"
              tags={["React", "Next.js", "Spotify API"]}
              githubUrl="https://github.com/username/find-tunes"
              demoUrl="https://find-tunes.vercel.app"
            />
          </div>
        </section>
            ...
            <Card className="flex-1">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Link href="https://github.com/BigBen-7" className="hover:underline">
                    github.com/BigBen-7
                  </Link>
                </div>
                <div className="flex items-center gap-3">
                  <Linkedin className="h-5 w-5 text-muted-foreground" />
                  <Link href="https://www.linkedin.com/in/benard-simon-181413244" className="hover:underline">
                    linkedin.com/in/benard-simon-181413244
                  </Link>
                </div>
              </CardContent>
              <CardFooter>
                <Button onClick={() => setIsContactOpen(true)} className="w-full transition-all hover:scale-[1.02]">
                  Send a Message
                </Button>
              </CardFooter>
            </Card>
            <Card className="flex-1">
              ...
              <CardContent>
                <ul className="space-y-2">
                  <li>
                    <Link href="https://drive.google.com/file/d/1SkiND40IFebFTnB7j8bDYwotqMrf26tX/view?usp=drive_link" className="flex items-center gap-2 hover:underline">
